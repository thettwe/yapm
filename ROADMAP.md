...
**V1 PM core complete** (changes 1–7): with `projects-roadmap` built, the whole tracker — workspace/auth, design system, issues, board, cycles, triage, and projects with a roadmap — is in place. With `connectors` (change 8) built, the delivery-truth wedge is live: GitHub PR/CI/deploy state feeds the issue-row reality strip and divergence flag. What remains (`ai`) is the work-graph-native AI, not core project management.
