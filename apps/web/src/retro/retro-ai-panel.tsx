...
//
//  1. **It renders nothing unless there is something real to show.** No row, `ai_off`, `failed`, or
//     `ready` with zero surviving proposals all render the empty string. The change-10 seed panel is
