...
- FROM: `### Requirement: Issue-row primitive with reserved reality-strip and divergence-flag slots`
- TO: `### Requirement: Issue-row primitive with reserved reality-track slot`
...
- **THEN** the reality-track slot is present in the layout in the track's quiet empty state, and the row layout does not shift when it is populated
